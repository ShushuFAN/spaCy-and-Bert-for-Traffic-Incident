...
class Model_data_preparation(object):
    ...
    def __init__(self, RAW_DATA_INPUT_DIR="raw_data", DATA_OUTPUT_DIR="classfication_data",
                 vocab_file_path="vocab.txt", do_lower_case=True, Competition_Mode=True, Valid_Model=False):
        '''
    ...
    def get_vocab_file_path(self, vocab_file_path):
        vocab_file_path = os.path.join(
            os.path.abspath(os.path.join(os.path.dirname(__file__), "../../pretrained_model/bert-base-uncased")), vocab_file_path)
