...
class HK_TN_Multi_Label_Classification_Processor(DataProcessor):
    ...
    def get_labels(self):
        return ['Affect','Status','Lane','Direction','Near','Between','Arrangement','Location']
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        print("tf.variable_scope:loss: %s"%loss)
...
def main(_):
    ...
    processors = {
        "hk_tn": HK_TN_Multi_Label_Classification_Processor,
    }
